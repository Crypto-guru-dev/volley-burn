...
const ProofOfBurn: FunctionComponent = () => {
  return (
    <div className="min-h-[1800px] relative w-full mx-auto flex flex-col items-end justify-start gap-5  text-left text-xl text-white font-oswald -translate-y-20 bg-[#270E63] z-10">
      <div className="relative z-10 w-full mx-auto flex flex-col items-end justify-start gap-5 text-left text-xl text-white font-oswald -translate-y-20 ">
        <div className="proof-of-burn header  w-full flex flex-col items-center justify-between relative  z-[30]  p-0.5 bg-gradient-to-b from-mediumspringgreen-300 to-pink-400 rounded-3xl md:rounded-full ">
          <div className="h-full w-full flex flex-col items-center bg-[linear-gradient(180deg,_#13134F_35.78%,_#4F018B_100%)] rounded-3xl md:rounded-full p-5 md:p-0 gap-y-5 md:gap-y-0">
            <div className="w-11/12 md:w-2/3 mx-auto grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-10 place-content-center items-center justify-between md:-translate-y-1/2 ">
              <div className="h-16 z-20 relative shadow-[0px_6px_9.8px_rgba(0,_0,_0,_0.25)] rounded-lg [background:linear-gradient(180deg,_#13134f,_#4f018b)] flex flex-row items-center justify-center  text-left  text-white font-oswald ">
                <div
              ...
              <div className="h-full relative shadow-[0px_6px_9.8px_rgba(0,_0,_0,_0.25)] rounded-lg [background:linear-gradient(180deg,_#13134f,_#4f018b)] flex flex-row items-center justify-center z-[19] text-left  text-white font-oswald ">
                <div
                  className="absolute -inset-[2px] bg-gradient-to-b from-mediumspringgreen-300 to-pink-400 rounded-lg"
                  aria-hidden="true"
                ></div>
              ...
              <div className="h-16 relative shadow-[0px_6px_9.8px_rgba(0,_0,_0,_0.25)] rounded-lg [background:linear-gradient(180deg,_#13134f,_#4f018b)] flex flex-row items-center justify-center z-[19] text-left  text-white font-oswald ">
                <div
                  className="absolute -inset-[2px] bg-gradient-to-b from-mediumspringgreen-300 to-pink-400 rounded-lg"
                  aria-hidden="true"
                ></div>
